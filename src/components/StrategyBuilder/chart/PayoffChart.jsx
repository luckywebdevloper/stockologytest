...
const PayoffChart = () => {
  ...
  const drawChart = () => {
    ...
    const onMouseMove = (e) => {
      ...
      const adjustedX =
        x +
        Math.max(MARGIN.LEFT, xTooltip.clientWidth / 2) -
        Math.min(MARGIN.RIGHT, xTooltip.clientWidth / 2) +
        10;

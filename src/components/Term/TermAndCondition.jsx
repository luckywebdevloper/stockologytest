            ...
            >
              ...
              <TabPanels>
                <TabPanel textAlign={"justify"}>
                  ...
                  <Text fontSize={"sm"} my="4">
                    17. SCOPE OF THE AGREEMENT: a. The Company agrees to permit
                    the User to register its details in the Company’s website
                    and/or application. The User shall choose a password and
                    shall maintain the confidentiality of the password and
                    account. The User is fully responsible for all activities
                    that occur while using their password or account. It is the
                    duty of the User to notify the Company immediately of any
                    unauthorized use of their password or account or any other
                    breach of security. The Company will not be liable for any
                    loss that may be incurred by the User as a result of
                    unauthorized use of their password or account, either with
                    or without their knowledge. b. Additionally, the Company
                    itself may provide terms and guidelines that govern
                    particular features, offers or the operating rules and
                    policies applicable to each Service or product of the
                    Company. The User shall be responsible for ensuring
                    compliance with the terms and guidelines or operating rules
                    and policies of the Service Provider with whom the User
                    elects to deal, including terms and conditions set forth in
                    a Service Providers' fare rules, contract of carriage or
                    other rules.
                  </Text>
                  <Text fontSize={"sm"} my="4">
                ...
                <TabPanel px={"20"} textAlign="justify">
                  <Text fontSize={"sm"} my="4">
                    STOCKOLOGY EDUCATION would like to thank you for visiting
                    our website. Respecting the Privacy and choices of our
                    online Customers and Visitors is important for us. We hope
                    that the information provided below will address any
